...
class WavefrontProxyReporter(WavefrontReporter):
    ...
    # pylint: disable=too-many-arguments
    def __init__(self, host, metrics_port=2878, distribution_port=None,
                 tracing_port=None, source='wavefront-pyformance',
        ...
        self.wavefront_client = WavefrontProxyClient(
            host=host, metrics_port=metrics_port,
            distribution_port=distribution_port, tracing_port=tracing_port)
